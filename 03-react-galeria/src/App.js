...
function GaleriaDeImagenes() {
    const [imagenes, setImagenes] = useState([
        { src: 'imgs/foto1.jpg', alt: 'Imagen 1', caption: 'Pie de foto Imagen 1' },
        { src: 'imgs/foto2.jpg', alt: 'Imagen 2', caption: 'Pie de foto Imagen 2' },
        { src: 'imgs/foto3.jpg', alt: 'Imagen 3', caption: 'Pie de foto Imagen 3' },
        { src: 'imgs/foto4.jpg', alt: 'Imagen 4', caption: 'Pie de foto Imagen 4' }
    ]);
    ...
    return (
        ...
        <div>
            ...
            <h1 style={{ textAlign: 'center' }}>Galería de imágenes con React </h1>
